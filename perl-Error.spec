...
%prep
%setup -q -n Error-0.17030
cd %{_builddir}/Error-0.17030
...
cp %{_builddir}/Error-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/perl-Error/38e94f89ec602e1a6495ef7c30477d01aeefedc9 || :
if test -f Makefile.PL; then
